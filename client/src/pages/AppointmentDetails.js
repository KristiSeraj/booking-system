      ...
      <div className="flex justify-between items-center">
        {appointment.status !== 'Completed' && (
          <button
            ...
            className="bg-green-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-200"
          >
            Mark as Completed
          </button>
        )}
        <button
          ...
          className="bg-red-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 transition-all duration-200"
        >
          Cancel Appointment
        </button>
      </div>
